...
public abstract class StudyToolManagementSystem {
    ...
    private void studyToolEditor(String id) {
        ...
        StudyToolDisplayer studyToolDisplayer = new StudyToolDisplayer(promptsMap);
        while (editing) {
            studyToolDisplayer.displayAllQuestionsAndAnswers(qa);
    ...
    /**
     * display the question, prompt for an answer and check correctness.
     * @param qa the question and answer.
     * @param templateType the template type which the study tool is made from.
     * @param answerChecker the answerChecker of the study tool.
     * @return correctness.
     */
