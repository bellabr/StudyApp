...
public class StudyToolManager implements Serializable {
    ...
    /**
     * Replaces one study tool with another. The two study tool's ID are assumed to be the same.
     */
    ...
    /**
     * each map represents configs of a study tool, labels: {name, id, accessibility, author's id}
     */
    ...
    **/
    ...
    public AnswerChecker getAnswerChecker(String studyToolId) {
         return this.getStudyToolByID(studyToolId).getAnswerChecker();
    }
